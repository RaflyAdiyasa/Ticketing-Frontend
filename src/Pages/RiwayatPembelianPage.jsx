          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm font-medium">Total Transaksi Anda</p>
                  <p className="text-3xl font-bold mt-1">{statusStats.all} Transaksi</p>
                  <p className="text-blue-100 text-sm mt-2">
                    {statusStats.paid} berhasil • {statusStats.pending} menunggu • {statusStats.failed + statusStats.expired + statusStats.cancelled} gagal
                  </p>
                </div>
                <motion.div 
